    ...
    <section class="py-20 px-6 bg-[#021017]">
        <div class="container mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <div class="bg-white/10 backdrop-blur-sm shadow-lg rounded-xl p-8 text-center transition duration-500 transform hover:-translate-y-2 hover:scale-105 hover:bg-white/20">
