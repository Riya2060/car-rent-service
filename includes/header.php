...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
     <base href="http://localhost:8888/carbooking-system/carbooking-master/">
    <style>
        body {
...
<header class="bg-white text-[#011A27] shadow-md sticky top-0 z-50">
    <nav class="container mx-auto px-1 py-2 flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-8 font-medium">
            ...
            <a href="pages/booking.php" class="text-[#011A27] hover:text-[#F0810F] transition duration-300">Bookings</a>
